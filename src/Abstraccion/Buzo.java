 ...
 */
public class Buzo extends Abstract_prenda{//creamos una clase que implemente la clase abstract_prenda
    
    public Buzo(Seleccion_color tono, Seleccion_talla talla){//realiamos el constructor de la clase donde su entrada sera una referencia a la interface de seleccion_color
    ...
    public void prenda(){//implementaion del metodo abstracto
        System.out.println("\n\nHas seleccionado el buzo");//imprimimos texto
